...
const PUBLIC_SIGNUP_ENABLED = String(process.env.EFL_PUBLIC_SIGNUP_ENABLED || '').toLowerCase() === 'true';
...
export function eflAuthReadiness() {
  ...
  return { coreConfigured, emailConfigured, signupFlagEnabled: PUBLIC_SIGNUP_ENABLED, publicSignupEnabled: coreConfigured && emailConfigured && PUBLIC_SIGNUP_ENABLED };
}

...
export async function submitFranchiseClaim(user, leagueId, rosterId) {
  ...
  await sql`
    ...
    ON CONFLICT(user.id, league.id) DO UPDATE SET membership_type='member', updated_at=NOW()
  `;
